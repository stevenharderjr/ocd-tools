...
<div class="backdrop">
	<div class="calculator-body">
		...
		<div class="calculator-buttons">
			...
			>
			<button on:click={handleButtonPress} aria-label="apply coupon" id="coupon" title="coupon"
				><span><img src="coupon.svg" alt="price tag" style="height: 1.5rem; width: 1.5rem;" /></span
				></button
			>
			...
			{:else}
				...
				>
			{/if}
			<button on:click={handleButtonPress} aria-label="7" id="7"
				><span class="inverted">7</span></button
			>
			<button on:click={handleButtonPress} aria-label="8" id="8"
				><span class="inverted">8</span></button
			>
			<button on:click={handleButtonPress} aria-label="9" id="9"
				><span class="inverted">9</span></button
			>
			<button on:click={handleButtonPress} aria-label="multiply" id="*"
				><span class={operator === '*' ? 'highlighted' : ''}>×</span></button
			>
			<button on:click={handleButtonPress} aria-label="4" id="4"
				><span class="inverted">4</span></button
			>
			<button on:click={handleButtonPress} aria-label="5" id="5"
				><span class="inverted">5</span></button
			>
			<button on:click={handleButtonPress} aria-label="6" id="6"
				><span class="inverted">6</span></button
			>
			<button on:click={handleButtonPress} aria-label="subtract" id="-"
				><span class={operator === '-' ? 'highlighted' : ''}>−</span></button
			>
			<button on:click={handleButtonPress} aria-label="1" id="1"
				><span class="inverted">1</span></button
			>
			<button on:click={handleButtonPress} aria-label="2" id="2"
				><span class="inverted">2</span></button
			>
			<button on:click={handleButtonPress} aria-label="3" id="3"
				><span class="inverted">3</span></button
			>
			<button on:click={handleButtonPress} aria-label="add" id="+"
				><span class={operator === '+' ? 'highlighted' : ''}>+</span></button
			>
			<button
				style="grid-column:1/3; width: 100%;"
				on:click={handleButtonPress}
				aria-label="0"
				id="0"><span class="inverted">0</span></button
			>
			<button
				on:click={handleButtonPress}
				aria-label="."
				id="."
				title="value to numerator (create fraction)"><span class="inverted">.</span></button
			>
			<button on:click={handleButtonPress} aria-label="equals" id="="><span>=</span></button>
		</div>
	</div>
</div>
